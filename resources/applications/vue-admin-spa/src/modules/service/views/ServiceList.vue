<template>
	<v-container>
		...
		<v-row v-if="!hideTitleBar" align="end">
			<v-col>
				<div class="headline font-weight-bold">Capabilitities</div>
				<div class="subtitle-2 grey--text">Capabilitities that registered in this system.</div>
			</v-col>
		</v-row>
		<!--- Introduction end --->
...
export default{
	...
	methods:{
		...
		getResourceData_(){
			...
			ServiceClient.getServiceList(payload).then((res)=>{
