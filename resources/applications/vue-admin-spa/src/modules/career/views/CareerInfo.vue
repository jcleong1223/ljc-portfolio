...
export default{
	...
	data(){
		return {
			...
			datablock_values: [
				...
				DataBlockOption.constructTextValue('Location', 'location'),
				DataBlockOption.constructTextValue('Salary Range', 'salary_range'),
				DataBlockOption.constructTextValue('Years of Experience', 'exp_required'),
				DataBlockOption.constructTextValue('Job Type', 'type'),
				DataBlockOption.constructTextValue('Career Level', 'career_level'),
				DataBlockOption.constructTextValue('Sequence Value', 'seq_value'),
				DataBlockOption.constructTextValue('Specializations', 'specializations'),
				DataBlockOption.constructTextValue('Qualification', 'qualifications'),
	...
	created(){
		...
		this.breadcrumbs_data = [
			{ text: 'Career List', disabled: false, to:  '/careers/list' },
			{ text: 'Career Info', disabled: true },
		];
	...
	methods:{
		getResourceData_(){
			CareerClient.getCareerInfo(this.infoID).then((res) => {
